...
JNIEXPORT jlong JNICALL Java_de_libalf_jni_AlgorithmAngluinColumn_init__JI (JNIEnv *env, jobject obj, jlong knowledgebase_pointer, jint alphabet_size) {
...
JNIEXPORT jlong JNICALL Java_de_libalf_jni_AlgorithmAngluinColumn_init__JIJ (JNIEnv *env, jobject obj, jlong knowledgebase_pointer, jint alphabet_size, jlong logger_pointer) {
	// Get the knowledgebase object
	knowledgebase<bool> *base = (knowledgebase<bool>*) knowledgebase_pointer;
