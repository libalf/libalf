 ...
 * knowledgebase. In this demo, the DeLeTe2 algorithm is used.
 */
...
int main(int argc, char**argv) {
	...
	/*
	 * Create learning algorithm (DeLeTe2 L*) without a logger (2nd argument is NULL)
	 * and alphabet size alphabet_size
	 */
	DeLeTe2<bool> algorithm(&base, NULL, alphabetsize);
