...
class nondeterministic_mVCA : public mVCA {
	protected: // types
		typedef map<int, nondeterministic_transition_function>::iterator iterator;
		typedef map<int, nondeterministic_transition_function>::const_iterator const_iterator;
	protected: // data
