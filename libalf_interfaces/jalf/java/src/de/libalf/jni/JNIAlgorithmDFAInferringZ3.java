...
public class JNIAlgorithmDFAInferringZ3 extends JNILearningAlgorithm {
	 ...
	 *            domain.
	 */
	public JNIAlgorithmDFAInferringZ3(Knowledgebase knowledgebase,
	 ...
	 * <code>DFA Inferring Z3</code> object with the pointer to a
	 ...
	 * {@link JNIAlgorithmDFAInferringZ3#uses_binary_search()}.
	 * </p>
	 * 
	 * @param pointer
	 ...
	 * <p>
	 * <em>JNI method call:</em> See
	 * {@link JNIAlgorithmDFAInferringZ3#set_using_variables()}.
	 * </p>
	 * 
	 * @param pointer
	 *            the pointer to the C++ object.
	 ...
	 * <p>
	 * <em>JNI method call:</em> See
	 * {@link JNIAlgorithmDFAInferringZ3#is_using_enum()}.
	 * </p>
	 * 
	 * @param pointer
	 *            the pointer to the C++ object.
	 ...
	 * <p>
	 * <em>JNI method call:</em> See
	 * {@link JNIAlgorithmDFAInferringZ3#is_logging_model()}.
	 * </p>
	 * 
	 * @param pointer
	 *            the pointer to the C++ object.
	 ...
	 * <p>
	 * <em>JNI method call:</em> See
	 * {@link JNIAlgorithmDFAInferringZ3#set_log_model(boolean)}.
	 * </p>
	 * 
	 * @param pointer
	 *            the pointer to the C++ object.
