...
public class JNIAlgorithmNFAInferringMinisat extends JNILearningAlgorithm {
	 ...
	 *            domain.
	 */
	public JNIAlgorithmNFAInferringMinisat(Knowledgebase knowledgebase,
			Logger logger, int alphabet_size, boolean use_symmetry_breaking) {
	 ...
	 * {@link JNIAlgorithmNFAInferringMinisat#uses_binary_search()}.
	 * </p>
	 * 
	 * @param pointer
	 ...
	 * <p>
	 * <em>JNI method call:</em> See
	 * {@link JNIAlgorithmNFAInferringMinisat#set_using_variables()}.
	 * </p>
	 * 
	 * @param pointer
	 *            the pointer to the C++ object.
	 ...
	 * <p>
	 * <em>JNI method call:</em> See
	 * {@link JNIAlgorithmNFAInferringMinisat#is_logging_model()}.
	 * </p>
	 * 
	 * @param pointer
	 *            the pointer to the C++ object.
	 ...
	 * <p>
	 * <em>JNI method call:</em> See
	 * {@link JNIAlgorithmNFAInferringMinisat#set_log_model(boolean)}.
	 * </p>
	 * 
	 * @param pointer
	 *            the pointer to the C++ object.
