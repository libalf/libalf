...
public interface LibALFFactory extends LibALFObject {
	static enum Algorithm {
		...
		INFER_DETERMINISTIC_CSP_MINISAT, INFER_DETERMINISTIC_CSP_Z3,
		INFER_DETERMINISTIC_MINISAT, INFER_DETERMINISTIC_Z3,
		INFER_DFA_MINISAT, INFER_DFA_Z3, INFER_NFA_MINISAT,
		INFERRING_CSP_MINISAT,
		INFERRING_CSP_Z3,
		INFERRING_MINISAT,
		INFERRING_Z3,
		INFERRING_DFA_MINISAT,
		INFERRING_DFA_Z3,
		INFERRING_NFA_MINISAT,
