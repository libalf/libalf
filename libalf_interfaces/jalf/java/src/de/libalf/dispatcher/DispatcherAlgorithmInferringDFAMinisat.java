...
public class DispatcherAlgorithmInferringDFAMinisat extends DispatcherLearningAlgorithm {
	private static final long serialVersionUID = 1L;

	public DispatcherAlgorithmInferringDFAMinisat(DispatcherFactory factory, Knowledgebase base, int alphabet_size, Logger logger) {
