...
#include "jni_algorithm_dfa_inferring_minisat.h"

using namespace std;
using namespace libalf;
JNIEXPORT jlong JNICALL Java_de_libalf_jni_JNIAlgorithmDFAInferringMinisat_init__JJIZ (JNIEnv * env, jobject obj, jlong kb_pointer, jlong log_pointer, jint alphabet_size, jboolean symmetry_breaking) {
...
JNIEXPORT jlong JNICALL Java_de_libalf_jni_JNIAlgorithmDFAInferringMinisat_init__JIZ (JNIEnv * env, jobject obj, jlong kb_pointer, jint alphabet_size, jboolean symmetry_breaking) {
	// Get the knowledgebase object
	knowledgebase<bool> *base = (knowledgebase<bool>*) kb_pointer;
