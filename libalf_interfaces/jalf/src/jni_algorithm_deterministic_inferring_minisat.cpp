...
#include "jni_algorithm_deterministic_inferring_minisat.h"

using namespace std;
using namespace libalf;
JNIEXPORT jlong JNICALL Java_de_libalf_jni_JNIAlgorithmDeterministicInferringMinisat_init__JJIZ (JNIEnv * env, jobject obj, jlong kb_pointer, jlong log_pointer, jint alphabet_size, jboolean symmetry_breaking) {
	 ...
	 */
	learning_algorithm<bool>* algorithm = new deterministic_inferring_MiniSat<bool>(base, logger, alphabet_size, symmetry_breaking);
	return ((jlong)algorithm);
}

JNIEXPORT jlong JNICALL Java_de_libalf_jni_JNIAlgorithmDeterministicInferringMinisat_init__JIZ (JNIEnv * env, jobject obj, jlong kb_pointer, jint alphabet_size, jboolean symmetry_breaking) {
	// Get the knowledgebase object
	knowledgebase<bool> *base = (knowledgebase<bool>*) kb_pointer;
	 ...
	 * Return the new object
	 */
	learning_algorithm<bool>* algorithm = new deterministic_inferring_MiniSat<bool>(base, NULL, alphabet_size, symmetry_breaking);
	return ((jlong)algorithm);
}
...
JNIEXPORT jboolean JNICALL Java_de_libalf_jni_JNIAlgorithmDeterministicInferringMinisat_uses_1symmetry_1breaking (JNIEnv * env, jobject obj, jlong pointer) {
	...
	deterministic_inferring_MiniSat<bool>* algorithm = (deterministic_inferring_MiniSat<bool>*)pointer;
